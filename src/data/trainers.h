const struct Trainer gTrainers[] = {
    ...
    [TRAINER_PSYCHICKEY] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
		.aiFlags = AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SETUP_FIRST_TURN | AI_FLAG_HP_AWARE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_SETUP_FIRST_TURN | AI_FLAG_PREFER_STRONGEST_MOVE | AI_FLAG_POWERFUL_STATUS | AI_FLAG_HELP_PARTNER | AI_FLAG_SMART_SWITCHING,
