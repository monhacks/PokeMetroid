...
#define FLAG_TEMP_DOUBLE     (TEMP_FLAGS_START + 0x10) // Unused Flag
...
#define FLAG_SPAWN           0x20 // Unused Flag
#define FLAG_NO_WILD         0x21 // Unused Flag
#define FLAG_DOUBLE_WILD     0x22 // Unused Flag
#define FLAG_RECEIVED_QUICK_ATTACK    0x23 // Unused Flag
#define FLAG_RECEIVED_INFESTATION   0x24 // Unused Flag
#define FLAG_PETALBURG_WOODS_VISIITED    0x25 // Unused Flag
#define FLAG_STARTOFGAME    0x26 // Unused Flag
...
#define FLAG_RECEIVED_TM_BODY_SLAM        0xAC
...
#define FLAG_STARTER                         0x1DE // Added for removing starter grab
#define FLAG_RUNGATE                         0x1DF // Unused Flag
