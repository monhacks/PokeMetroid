...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_TEMP_DOUBLE    // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        FLAG_SPAWN     // If not 0, you can set this flag in a script to enable smart wild pokemon
